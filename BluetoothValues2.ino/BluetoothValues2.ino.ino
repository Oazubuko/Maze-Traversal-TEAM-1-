...
BLEUnsignedCharCharacteristic messageCharacteristic("0fe79935-cd39-480a-8a44-06b70f36f24a", BLERead | BLEWrite);
...
void setup() {
  ...
  motorService.addCharacteristic(messageCharacteristic);
  ...
  messageCharacteristic.setValue('a');
  BLE.advertise();
...
void loop() 
{
  ...
  messageCharacteristic.setValue(messageCharacteristic+1);
