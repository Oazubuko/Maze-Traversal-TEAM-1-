    ...
    async def connect(self):
        ...
        try:
            ...
            if self.connected:
                ...
                elif self.connected_device == "2C:72:52:BE:CC:0D":
...
if __name__ == "__main__":
    ...
    connection_Loaner = connection(loop, Loaner_flag_characteristic, Loaner_dir_characteristic)
    ...
    try:
        if mouse == "Ed":
            ...
            asyncio.ensure_future(connection_Machi.manager(4))
